...
CREATE TYPE public.app_role AS ENUM ('admin', 'lider', 'tecnico', 'operador');
...
-- Update usuarios table policies to allow insert for signup
...
BEGIN
  ...
  -- Insert role based on perfil
  INSERT INTO public.user_roles (user_id, role)
  VALUES (
    NEW.id,
    COALESCE(NEW.raw_user_meta_data->>'perfil', 'operador')::app_role
  );
